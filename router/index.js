...
router.post('/addContact', koaBody(), controller.addContact)
router.post('/addLoopReserve', koaBody(), controller.addLoopReserve)
...
router.get('/getRandomLoop', controller.getRandomLoop)
...
router.get('/getSelectLoop', controller.getSelectLoop)
router.get('/getContactList', controller.getContactList)
router.post("/deleteContactList", koaBody(), controller.deleteContactList)
router.get('/getLoopReserveList', controller.getLoopReserveList)
router.post("/deleteLoopReserveList", koaBody(), controller.deleteLoopReserveList)
router.get('/getCarList', controller.getCarList)
router.post('/getCar', koaBody(), controller.getCar)
router.post('/addCar', koaBody(), controller.addCar)
router.post('/editCar', koaBody(), controller.editCar)
router.post('/deleteCar', koaBody(), controller.deleteCar)
module.exports = app => {
